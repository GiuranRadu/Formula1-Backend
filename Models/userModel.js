...
const Circuit = require('./circuitModel'); // Import the Circuit model
...
const userSchema = new mongoose.Schema({
  ...
  team: {
    type: String,
    enum: ['none', "Mercedes", "Alpine", "Haas F1 Team", "Red Bull Racing", "McLaren", "Aston Martin", "Ferrari", "Kick Sauber", "Williams", "AlphaTauri", "Renault", "Alfa Romeo"],
    default: 'none'
  },
  country: {
    type: String,
  ...
  picture: {
    type: String,
    default: 'https://res.cloudinary.com/dqmwih53s/image/upload/v1714314099/formula1/jepwvvfbdh2doii5sfkj.jpg',
  },
  passwordChangedAt: {
    type: Date
  },
  ...
  circuits: [{
    ...
    name: String,
    country: String,
    location: String, //s-ar putea sa fie inutil
